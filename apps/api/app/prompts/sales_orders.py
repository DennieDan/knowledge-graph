SALES_ORDER_PROMPT = (
    "Extract one customer sales order and write a concise natural-language report for an operations user. "
    "Do not treat supplier orders, quotations, invoices, delivery orders, or production jobs as sales orders.\n"
    ...
    "Summarize the customer and order identity, what was ordered and in what quantities, "
    "important dates and delivery requirements, commercial terms, and any later changes or approvals. "
